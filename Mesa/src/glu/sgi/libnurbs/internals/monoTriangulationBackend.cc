...
**
** $Date: 2005/07/06 09:25:39 $ $Revision: 1.1.1.1 $
*/
/*
** $Header: /sources/cvsroot/Mesa/src/glu/sgi/libnurbs/internals/monoTriangulationBackend.cc,v 1.1.1.1 2005/07/06 09:25:39 gully Exp $
*/
