 ...
 * $Header: /sources/cvsroot/redland/perl/CORE_wrap.c,v 1.1.1.1 2005/07/06 09:38:37 gully Exp $
 * ----------------------------------------------------------------------------- */
...
XS(_wrap_librdf_model_find_statements_in_context) {
    ...
    const char *_swigerr = _swigmsg;
    {
        ...
        if ((items < 3) || (items > 3)) {
            SWIG_croak("Usage: librdf_model_find_statements_in_context(model,statement,context_node);");
        }
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_p_librdf_model,0) < 0) {
                SWIG_croak("Type error in argument 1 of librdf_model_find_statements_in_context. Expected _p_librdf_model");
            }
        }
        {
            if (SWIG_ConvertPtr(ST(1), (void **) &arg2, SWIGTYPE_p_librdf_statement,0) < 0) {
                SWIG_croak("Type error in argument 2 of librdf_model_find_statements_in_context. Expected _p_librdf_statement");
            }
        }
        {
            if (SWIG_ConvertPtr(ST(2), (void **) &arg3, SWIGTYPE_p_librdf_node,0) < 0) {
                SWIG_croak("Type error in argument 3 of librdf_model_find_statements_in_context. Expected _p_librdf_node");
            }
        }
...
XS(_wrap_librdf_model_get_contexts) {
    ...
    const char *_swigerr = _swigmsg;
    {
        ...
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_p_librdf_model,0) < 0) {
                SWIG_croak("Type error in argument 1 of librdf_model_get_contexts. Expected _p_librdf_model");
            }
        }
...
XS(_wrap_librdf_model_get_feature) {
    ...
    const char *_swigerr = _swigmsg;
    {
        ...
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_p_librdf_model,0) < 0) {
                SWIG_croak("Type error in argument 1 of librdf_model_get_feature. Expected _p_librdf_model");
            }
        }
        {
            if (SWIG_ConvertPtr(ST(1), (void **) &arg2, SWIGTYPE_p_librdf_uri,0) < 0) {
                SWIG_croak("Type error in argument 2 of librdf_model_get_feature. Expected _p_librdf_uri");
            }
        }
...
XS(_wrap_librdf_model_set_feature) {
    ...
    const char *_swigerr = _swigmsg;
    {
        ...
        {
            if (SWIG_ConvertPtr(ST(0), (void **) &arg1, SWIGTYPE_p_librdf_model,0) < 0) {
                SWIG_croak("Type error in argument 1 of librdf_model_set_feature. Expected _p_librdf_model");
            }
        }
        {
            if (SWIG_ConvertPtr(ST(1), (void **) &arg2, SWIGTYPE_p_librdf_uri,0) < 0) {
                SWIG_croak("Type error in argument 2 of librdf_model_set_feature. Expected _p_librdf_uri");
            }
        }
        {
            if (SWIG_ConvertPtr(ST(2), (void **) &arg3, SWIGTYPE_p_librdf_node,0) < 0) {
                SWIG_croak("Type error in argument 3 of librdf_model_set_feature. Expected _p_librdf_node");
            }
        }
...
XS(_wrap_librdf_parser_set_feature) {
    ...
    const char *_swigerr = _swigmsg;
    {
        ...
        {
            if (SWIG_ConvertPtr(ST(2), (void **) &arg3, SWIGTYPE_p_librdf_node,0) < 0) {
                SWIG_croak("Type error in argument 3 of librdf_parser_set_feature. Expected _p_librdf_node");
            }
        }
...
XS(_wrap_librdf_serializer_set_feature) {
    ...
    const char *_swigerr = _swigmsg;
    {
        ...
        {
            if (SWIG_ConvertPtr(ST(2), (void **) &arg3, SWIGTYPE_p_librdf_node,0) < 0) {
                SWIG_croak("Type error in argument 3 of librdf_serializer_set_feature. Expected _p_librdf_node");
            }
        }
...
{"RDF::Redland::CORE::librdf_model_find_statements_in_context", _wrap_librdf_model_find_statements_in_context},
...
{"RDF::Redland::CORE::librdf_model_get_contexts", _wrap_librdf_model_get_contexts},
{"RDF::Redland::CORE::librdf_model_get_feature", _wrap_librdf_model_get_feature},
{"RDF::Redland::CORE::librdf_model_set_feature", _wrap_librdf_model_set_feature},
