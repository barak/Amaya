...
function_entry redland_functions[] = {
	...
	ZEND_NAMED_FE(librdf_model_find_statements_in_context,
		_wrap_librdf_model_find_statements_in_context, NULL)
	...
	ZEND_NAMED_FE(librdf_model_get_contexts,
		_wrap_librdf_model_get_contexts, NULL)
	ZEND_NAMED_FE(librdf_model_get_feature,
		_wrap_librdf_model_get_feature, NULL)
	ZEND_NAMED_FE(librdf_model_set_feature,
		_wrap_librdf_model_set_feature, NULL)
	...
	ZEND_NAMED_FE(librdf_php_get_world,
		_wrap_librdf_php_get_world, NULL)
	ZEND_NAMED_FE(librdf_php_world_finish,
		_wrap_librdf_php_world_finish, NULL)
...
ZEND_NAMED_FUNCTION(_wrap_librdf_model_find_statements_in_context) {
    ...
    if(SWIG_ConvertPtr(*((0<argbase)?(&this_ptr):(args[0-argbase])), (void **) &arg1, SWIGTYPE_p_librdf_model) < 0) {
        zend_error(E_ERROR, "Type error in argument %d of librdf_model_find_statements_in_context. Expected %s", 1-argbase, SWIGTYPE_p_librdf_model->name);
    }
    
    
    if(SWIG_ConvertPtr(*args[1-argbase], (void **) &arg2, SWIGTYPE_p_librdf_statement) < 0) {
        zend_error(E_ERROR, "Type error in argument %d of librdf_model_find_statements_in_context. Expected %s", 2-argbase, SWIGTYPE_p_librdf_statement->name);
    }
    
    
    if(SWIG_ConvertPtr(*args[2-argbase], (void **) &arg3, SWIGTYPE_p_librdf_node) < 0) {
        zend_error(E_ERROR, "Type error in argument %d of librdf_model_find_statements_in_context. Expected %s", 3-argbase, SWIGTYPE_p_librdf_node->name);
    }
...
ZEND_NAMED_FUNCTION(_wrap_librdf_model_get_contexts) {
    ...
    if(SWIG_ConvertPtr(*((0<argbase)?(&this_ptr):(args[0-argbase])), (void **) &arg1, SWIGTYPE_p_librdf_model) < 0) {
        zend_error(E_ERROR, "Type error in argument %d of librdf_model_get_contexts. Expected %s", 1-argbase, SWIGTYPE_p_librdf_model->name);
    }
...
ZEND_NAMED_FUNCTION(_wrap_librdf_model_get_feature) {
    ...
    if(SWIG_ConvertPtr(*((0<argbase)?(&this_ptr):(args[0-argbase])), (void **) &arg1, SWIGTYPE_p_librdf_model) < 0) {
        zend_error(E_ERROR, "Type error in argument %d of librdf_model_get_feature. Expected %s", 1-argbase, SWIGTYPE_p_librdf_model->name);
    }
    
    
    if(SWIG_ConvertPtr(*args[1-argbase], (void **) &arg2, SWIGTYPE_p_librdf_uri) < 0) {
        zend_error(E_ERROR, "Type error in argument %d of librdf_model_get_feature. Expected %s", 2-argbase, SWIGTYPE_p_librdf_uri->name);
    }
...
ZEND_NAMED_FUNCTION(_wrap_librdf_model_set_feature) {
    ...
    if(SWIG_ConvertPtr(*((0<argbase)?(&this_ptr):(args[0-argbase])), (void **) &arg1, SWIGTYPE_p_librdf_model) < 0) {
        zend_error(E_ERROR, "Type error in argument %d of librdf_model_set_feature. Expected %s", 1-argbase, SWIGTYPE_p_librdf_model->name);
    }
    
    
    if(SWIG_ConvertPtr(*args[1-argbase], (void **) &arg2, SWIGTYPE_p_librdf_uri) < 0) {
        zend_error(E_ERROR, "Type error in argument %d of librdf_model_set_feature. Expected %s", 2-argbase, SWIGTYPE_p_librdf_uri->name);
    }
    
    
    if(SWIG_ConvertPtr(*args[2-argbase], (void **) &arg3, SWIGTYPE_p_librdf_node) < 0) {
        zend_error(E_ERROR, "Type error in argument %d of librdf_model_set_feature. Expected %s", 3-argbase, SWIGTYPE_p_librdf_node->name);
    }
...
ZEND_NAMED_FUNCTION(_wrap_librdf_parser_set_feature) {
    ...
    if(SWIG_ConvertPtr(*args[2-argbase], (void **) &arg3, SWIGTYPE_p_librdf_node) < 0) {
        zend_error(E_ERROR, "Type error in argument %d of librdf_parser_set_feature. Expected %s", 3-argbase, SWIGTYPE_p_librdf_node->name);
    }
...
ZEND_NAMED_FUNCTION(_wrap_librdf_serializer_set_feature) {
    ...
    if(SWIG_ConvertPtr(*args[2-argbase], (void **) &arg3, SWIGTYPE_p_librdf_node) < 0) {
        zend_error(E_ERROR, "Type error in argument %d of librdf_serializer_set_feature. Expected %s", 3-argbase, SWIGTYPE_p_librdf_node->name);
    }
