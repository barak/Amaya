...
public class Redland {
  ...
  public static SWIGTYPE_p_librdf_stream_s librdf_model_find_statements_in_context(SWIGTYPE_p_librdf_model_s model, SWIGTYPE_p_librdf_statement_s statement, SWIGTYPE_p_librdf_node_s context_node) {
    IntPtr cPtr = RedlandPINVOKE.librdf_model_find_statements_in_context(SWIGTYPE_p_librdf_model_s.getCPtr(model), SWIGTYPE_p_librdf_statement_s.getCPtr(statement), SWIGTYPE_p_librdf_node_s.getCPtr(context_node));
    return (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_librdf_stream_s(cPtr, false);
  }
  ...
  public static SWIGTYPE_p_librdf_iterator_s librdf_model_get_contexts(SWIGTYPE_p_librdf_model_s model) {
    IntPtr cPtr = RedlandPINVOKE.librdf_model_get_contexts(SWIGTYPE_p_librdf_model_s.getCPtr(model));
    return (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_librdf_iterator_s(cPtr, false);
  }

  public static SWIGTYPE_p_librdf_node_s librdf_model_get_feature(SWIGTYPE_p_librdf_model_s model, SWIGTYPE_p_librdf_uri_s feature) {
    IntPtr cPtr = RedlandPINVOKE.librdf_model_get_feature(SWIGTYPE_p_librdf_model_s.getCPtr(model), SWIGTYPE_p_librdf_uri_s.getCPtr(feature));
    return (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_librdf_node_s(cPtr, false);
  }

  public static int librdf_model_set_feature(SWIGTYPE_p_librdf_model_s model, SWIGTYPE_p_librdf_uri_s feature, SWIGTYPE_p_librdf_node_s value) {
    return RedlandPINVOKE.librdf_model_set_feature(SWIGTYPE_p_librdf_model_s.getCPtr(model), SWIGTYPE_p_librdf_uri_s.getCPtr(feature), SWIGTYPE_p_librdf_node_s.getCPtr(value));
  }
  ...
  public static SWIGTYPE_p_librdf_node_s librdf_parser_get_feature(SWIGTYPE_p_librdf_parser_s parser, SWIGTYPE_p_librdf_uri_s feature) {
    IntPtr cPtr = RedlandPINVOKE.librdf_parser_get_feature(SWIGTYPE_p_librdf_parser_s.getCPtr(parser), SWIGTYPE_p_librdf_uri_s.getCPtr(feature));
    return (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_librdf_node_s(cPtr, false);
  }

  public static int librdf_parser_set_feature(SWIGTYPE_p_librdf_parser_s parser, SWIGTYPE_p_librdf_uri_s feature, SWIGTYPE_p_librdf_node_s value) {
    return RedlandPINVOKE.librdf_parser_set_feature(SWIGTYPE_p_librdf_parser_s.getCPtr(parser), SWIGTYPE_p_librdf_uri_s.getCPtr(feature), SWIGTYPE_p_librdf_node_s.getCPtr(value));
  }

  public static SWIGTYPE_p_librdf_serializer_s librdf_new_serializer(SWIGTYPE_p_librdf_world_s world, string name, string mime_type, SWIGTYPE_p_librdf_uri_s type_uri) {
    ...
    return (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_librdf_serializer_s(cPtr, false);
  }

  public static void librdf_free_serializer(SWIGTYPE_p_librdf_serializer_s serializer) {
    RedlandPINVOKE.librdf_free_serializer(SWIGTYPE_p_librdf_serializer_s.getCPtr(serializer));
  }

  public static int librdf_serializer_serialize_model_to_file(SWIGTYPE_p_librdf_serializer_s serializer, string name, SWIGTYPE_p_librdf_uri_s base_uri, SWIGTYPE_p_librdf_model_s model) {
    return RedlandPINVOKE.librdf_serializer_serialize_model_to_file(SWIGTYPE_p_librdf_serializer_s.getCPtr(serializer), name, SWIGTYPE_p_librdf_uri_s.getCPtr(base_uri), SWIGTYPE_p_librdf_model_s.getCPtr(model));
  }

  public static SWIGTYPE_p_librdf_node_s librdf_serializer_get_feature(SWIGTYPE_p_librdf_serializer_s serializer, SWIGTYPE_p_librdf_uri_s feature) {
    IntPtr cPtr = RedlandPINVOKE.librdf_serializer_get_feature(SWIGTYPE_p_librdf_serializer_s.getCPtr(serializer), SWIGTYPE_p_librdf_uri_s.getCPtr(feature));
    return (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_librdf_node_s(cPtr, false);
  }

  public static int librdf_serializer_set_feature(SWIGTYPE_p_librdf_serializer_s serializer, SWIGTYPE_p_librdf_uri_s feature, SWIGTYPE_p_librdf_node_s value) {
    return RedlandPINVOKE.librdf_serializer_set_feature(SWIGTYPE_p_librdf_serializer_s.getCPtr(serializer), SWIGTYPE_p_librdf_uri_s.getCPtr(feature), SWIGTYPE_p_librdf_node_s.getCPtr(value));
  }
  ...
  public static string librdf_short_copyright_string {
    get {
      return RedlandPINVOKE.get_librdf_short_copyright_string();
    } 
  }

  public static string librdf_copyright_string {
    get {
      return RedlandPINVOKE.get_librdf_copyright_string();
    } 
  }

  public static string librdf_version_string {
    get {
      return RedlandPINVOKE.get_librdf_version_string();
    } 
  }

  public static uint librdf_version_major {
    get {
      return RedlandPINVOKE.get_librdf_version_major();
    } 
  }

  public static uint librdf_version_minor {
    get {
      return RedlandPINVOKE.get_librdf_version_minor();
    } 
  }

  public static uint librdf_version_release {
    get {
      return RedlandPINVOKE.get_librdf_version_release();
    } 
  }

  public static uint librdf_version_decimal {
    get {
      return RedlandPINVOKE.get_librdf_version_decimal();
    } 
  }
